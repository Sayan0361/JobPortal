...
const Profile = ({ isDarkMode, userType }) => {
    ...
    if (!userType) {
        return (
            <div className={`min-h-screen flex items-center justify-center px-4 ${isDarkMode
                    ? 'bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900'
                    : 'bg-gradient-to-br from-blue-50 via-white to-indigo-50'
                }`}>
                <div className={`w-full max-w-md p-6 sm:p-8 rounded-3xl text-center ${isDarkMode
