...
const CommunityPage = ({ isDarkMode, user, userType }) => {
    return (
        <div
            className={`min-h-screen transition-all duration-300 ${isDarkMode ? "bg-zinc-900 text-white" : "bg-zinc-50 text-zinc-900"
                }`}
        >
            {/* Hero Section */}
            <div
                className={`relative w-full flex flex-col items-center justify-center py-16 md:py-28 px-4 text-center rounded-b-[40px] overflow-hidden ${isDarkMode
