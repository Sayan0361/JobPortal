...
export const ProfileCard = ({ user, isDarkMode, appliedJobs, userType, updateUser }) => {
    ...
    return (
        <div className={`max-w-4xl mx-auto mb-12 p-4 sm:p-6 md:p-8 rounded-3xl shadow-2xl border backdrop-blur-sm ${isDarkMode
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 sm:gap-8">
                ...
                <div className="relative group">
                    {user.profileImage ? (
                        ...
                        <div className={`w-28 h-28 sm:w-32 sm:h-32 rounded-2xl flex items-center justify-center border-4 ${isDarkMode ? 'border-zinc-600 bg-zinc-700/50' : 'border-zinc-300 bg-zinc-100'
                    ...
                    <button
                        ...
                        className={`absolute -bottom-3 -right-3 p-2 rounded-full shadow-lg ${isDarkMode ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'
                    ...
                    {editMode ? (
                        <div className="space-y-4">
                            <input
                                ...
                                className={`w-full p-3 rounded-xl text-lg font-semibold ${isDarkMode
                        ...
                        <>
                            ...
                            <div className="flex flex-wrap gap-4 justify-center sm:justify-start">
                                <div className={`px-4 py-2 rounded-xl ${isDarkMode ? 'bg-zinc-700/50' : 'bg-zinc-100'
                                    }`}>
